            ...
            <div className="grid size-full place-items-center">
                {
                    messageShow !== '' && (
                        <div className="flex absolute top-36 items-center w-full max-w-xs p-4 mb-4 rounded-lg shadow text-gray-400 bg-[#333]" role="alert">
                            ...
                            <div className="ms-3 text-sm font-normal">{messageShow}.</div>
                            <button onClick={() => setMessageShow(null)} className="ms-auto -mx-1.5 -my-1.5 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 inline-flex items-center justify-center h-8 w-8 text-gray-500 hover:text-white bg-[#222] hover:bg-[#444]" aria-label="Close">
