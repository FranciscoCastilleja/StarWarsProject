...
export default function CloseDiscussionButton({id}:{id:string}) {
    ...
    return (
        <section className="flex mt-3 w-full h-auto justify-center">
            {
                user?.user_metadata.full_name === data.created_by && (<button className="mb-3 p-2 text-white text-base bg-black/90 border border-white rounded-xl hover:bg-red-700 hover:border-red-700">Close Discussion</button>)
            }
        </section>
    );
}