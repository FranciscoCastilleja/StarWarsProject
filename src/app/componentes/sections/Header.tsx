    ...
    return (
        <>
            <header className="flex sticky py-3 w-full h-auto justify-center top-0 items-center gap-x-[8%] bg-[#111] border-b-2 border-white z-10 sm:gap-x-[20%] md:gap-x-[30%] lg:gap-x-[50%]">
                ...
                <nav className="flex items-center gap-x-3 lg:gap-x-5">
                    <Link href="/blog" className="hidden text-white text-xl hover:scale-105 hover:text-yellow-500 md:block">Blog</Link>
                    <Link href="/discussions" className="hidden text-white text-xl hover:scale-105 hover:text-yellow-500 md:block">Discussions</Link>
                    <Link href="/socials" className="hidden text-white text-xl hover:scale-105 hover:text-yellow-500 md:block">Socials</Link>
                    {
                        user == null ? (
            ...
            <nav className="flex sticky w-full h-14 top-[125.6px] bg-black/95 justify-center items-center gap-x-5 md:hidden">
                <Link href="/blog" className="block text-white text-xl hover:scale-105 hover:text-yellow-500 md:hidden">Blog</Link>
                <Link href="/discussions" className="block text-white text-xl hover:scale-105 hover:text-yellow-500 md:hidden">Discussions</Link>
                <Link href="/socials" className="block text-white text-xl hover:scale-105 hover:text-yellow-500 md:hidden">Socials</Link>
            </nav>
        </>
    );
}