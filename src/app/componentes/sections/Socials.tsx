        ...
        <section className="w-full h-auto md:w-[50%]">
            <article className="w-full h-auto">
                ...
                <div className="flex w-full h-auto flex-wrap justify-center items-center gap-x-5 gap-y-3">
                    ...
                    <span className="group grid relative place-items-center rounded-full">
                        <Link className="rounded-full border-2 border-transparent hover:scale-105 hover:border-[#FF0000]" title="Apolo1138" href="https://www.youtube.com/@Apolo1138" target="_blank" rel="noopener noreferrer"><Image width={100} height={100} className="rounded-full" src="/Media/Apolo1138.webp" alt="Picture of Apolo1138"/></Link>
                        <h3 className="absolute w-44 opacity-0 -bottom-10 text-white text-center font-bold -z-10 transition-opacity duration-500 ease-linear group-hover:opacity-100">Apolo1138</h3>
                    </span>
                </div>
            </article>
        </section>
