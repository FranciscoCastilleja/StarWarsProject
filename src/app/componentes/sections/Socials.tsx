            ...
            <article className="w-full h-auto">
                ...
                <div className="flex w-full h-auto flex-wrap justify-center items-center gap-x-5 gap-y-3">
                    <span className="group grid relative place-items-center rounded-full">
                        <Link className="rounded-full border-2 border-transparent hover:scale-105 hover:border-[#FFFF00]" title="La Guardia del Templo" href="https://www.youtube.com/@guardiadeltemplo" target="_blank"><Image width={100} height={100} className="rounded-full" src="/Media/GuardiaTemplo.webp" alt="Picture of La Guardia del Templo"/></Link>
                    ...
                    <span className="group grid relative place-items-center rounded-full">
                        <Link className="rounded-full border-2 border-transparent hover:scale-105 hover:border-[#FF0000]" title="La Sombra del Imperio" href="https://www.youtube.com/@LaSombradelImperio" target="_blank"><Image width={100} height={100} className="rounded-full" src="/Media/SombraImperio.webp" alt="Picture of La Sombra del Imperio"/></Link>
